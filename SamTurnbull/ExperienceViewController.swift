...
class ExperienceViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet weak var page4Header: UIImageView!
    @IBOutlet weak var page5Header: UIImageView!
    ...
    @IBOutlet weak var scrollArrow3YConstraint: NSLayoutConstraint!
    @IBOutlet weak var scrollArrow4YConstraint: NSLayoutConstraint!
    ...
    override func viewDidLoad() {
        ...
        page1Header.image = UIImage(named: "loughborough.jpg")
        ...
        page2Header.image = UIImage(named: "stanford.jpg")
        ...
        page3Header.image = UIImage(named: "app_mathsteam.jpg")
        ...
        page4Header.image = UIImage(named: "nsconference.jpg")
        page4Header.contentMode = .ScaleAspectFill
        page4Header.clipsToBounds = true
        textView4.backgroundColor = UIColor(white: 0.7, alpha: 0.6)
        textView4.textContainerInset = UIEdgeInsets(top: 15, left: 10, bottom: 0, right: 10)
        
        page5Header.image = UIImage(named: "app_project.jpg")
        page5Header.contentMode = .ScaleAspectFill
        page5Header.clipsToBounds = true
        textView5.backgroundColor = UIColor(white: 0.7, alpha: 0.6)
        textView5.textContainerInset = UIEdgeInsets(top: 15, left: 10, bottom: 0, right: 10)
    }
    ...
    func animateScrollArrow() {
        UIView.animateWithDuration(0.8, delay: 0.5, usingSpringWithDamping: 0.5, initialSpringVelocity: 1, options: UIViewAnimationOptions.CurveLinear, animations: { () -> Void in
            ...
            self.scrollArrow3YConstraint.constant = 30
            self.scrollArrow4YConstraint.constant = 30
            self.view.layoutIfNeeded()
                ...
                UIView.animateWithDuration(0.6, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 1, options: UIViewAnimationOptions.CurveLinear, animations: { () -> Void in
                    ...
                    self.scrollArrow3YConstraint.constant = 8
                    self.scrollArrow4YConstraint.constant = 8
                    self.view.layoutIfNeeded()
                    }) { (finished: Bool) -> Void in
    ...
    func scrollViewDidScroll(scrollView: UIScrollView) {
        if (scrollView.contentOffset.y == view.frame.height * 3) {
